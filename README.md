...
A curated list of deep learning resources for computer vision, inspired by [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,647 | 🐛 82 | 📅 2026-07-13 and [awesome-computer-vision](https://github.com/jbhuang0604/awesome-computer-vision) ⭐ 23,492 | 🐛 91 | 📅 2024-05-17.
...
Please feel free to [pull requests](https://github.com/kjw0612/awesome-deep-vision/pulls) ⭐ 11,178 | 🐛 47 | 📅 2023-08-15 to add papers.
...
* You Only Look Once: Unified, Real-Time Object Detection [\[Paper\]](http://arxiv.org/abs/1506.02640), [\[Paper Version 2\]](https://arxiv.org/abs/1612.08242), [\[C Code\]](https://github.com/pjreddie/darknet) ⭐ 26,490 | 🐛 1,975 | 🌐 C | 📅 2024-05-03, [\[Tensorflow Code\]](https://github.com/thtrieu/darkflow) ⭐ 6,140 | 🐛 642 | 🌐 Python | 📅 2023-10-23
...
* Colorful Image Colorization Richard Zhang, Phillip Isola, Alexei A. Efros, ECCV, 2016 [\[Paper\]](http://arxiv.org/pdf/1603.08511.pdf), [\[Code\]](https://github.com/richzhang/colorization) ⭐ 3,459 | 🐛 59 | 🌐 Python | 📅 2023-11-27
...
* Holistically-Nested Edge Detection [\[Paper\]](http://arxiv.org/pdf/1504.06375) [\[Code\]](https://github.com/s9xie/hed) ⭐ 1,923 | 🐛 75 | 🌐 C++ | 📅 2024-04-07
...
* Adversarial Networks
  * Jun-Yan Zhu, Philipp Krahenbuhl, Eli Shechtman, and Alexei A. Efros, "Generative Visual Manipulation on the Natural Image Manifold", ECCV 2016. \[[Paper](https://arxiv.org/pdf/1609.03552v2.pdf)] \[[Code](https://github.com/junyanz/iGAN) ⭐ 4,003 | 🐛 14 | 🌐 Python | 📅 2020-08-05] \[[Video](https://youtu.be/9c4z6YsBGQ0)]
...
* Deepgaze: A computer vision library for human-computer interaction based on CNNs \[[Web](https://github.com/mpatacchiola/deepgaze) ⭐ 1,878 | 🐛 11 | 🌐 Python | 📅 2024-05-09]
...
* Adversarial Training
  * Code and hyperparameters for the paper "Generative Adversarial Networks" [\[Web\]](https://github.com/goodfeli/adversarial) ⭐ 4,076 | 🐛 7 | 🌐 Python | 📅 2020-05-25
...
* Edge Detection
  * Source code for the paper "Holistically-Nested Edge Detection", ICCV 2015. [\[Web\]](https://github.com/s9xie/hed) ⭐ 1,923 | 🐛 75 | 🌐 C++ | 📅 2024-04-07
